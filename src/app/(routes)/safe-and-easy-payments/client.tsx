      ...
      <div className="relative">
        ...
        <div className="w-full lg:h-[500px] h-[440px] relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="lg:px-80 px-10 lg:mt-24 mt-14 text-white">
        ...
        <div className="lg:py-16 py-10 pb-0 lg:px-80 px-10">
          ...
          <div className="mt-16">
            ...
            <p className="text-gray-600 mb-12">
              Your payment security is guaranteed with our PCI-compliant payment
              gateway
            </p>
            ...
            <div>
              ...
              <div className="relative mb-8">
                ...
                <div className="ml-14 pb-8">
                  <p className="text-gray-600 mb-4">
                    Browse through our marketplace and select the items you want
                    to purchase. All transactions are protected by our secure
                    payment infrastructure.
                  </p>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <p className="text-sm text-green-700">
                      <strong>Note:</strong> All product has a feature of
                      "Secure Checkout" to ensure your payment is processed
                      securely.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative mb-8">
                ...
                <div className="ml-14 pb-8">
                  <p className="text-gray-600 mb-4">
                    Review your order details and shipping information. Our
                    checkout process is SSL-encrypted and PCI DSS compliant for
                    maximum security.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-14 pb-8">
                  <p className="text-gray-600 mb-4">
                    Choose from multiple secure payment options powered by
                    Xendit. All payment methods are tokenized and never stored
                    on our servers.
                  </p>
                  <div className="bg-[#f9fafb] h-[400px] overflow-hidden rounded-lg max-w-3xl flex justify-center shadow-sm border">
                    <img
                      src="/safe-payment.png"
                      alt="safe payment policy"
                      width={900}
                      height={500}
